...
export function ContactClient({ supportNumber }: { supportNumber: string }) {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-2 space-y-5">
              {[
                ...
                { icon: "fa-phone-alt", title: "Call us", sub: "Toll-free call", link: `tel:${supportNumber}`, linkText: supportNumber, external: true },
              ...
              {/* WhatsApp CTA */}
              <a href={`https://wa.me/${supportNumber.replace(/\\D/g, '')}`} target="_blank" rel="noopener"
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="glass-panel p-8 md:p-10 text-center space-y-5 border-primary/20">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
              <a href={`tel:${supportNumber}`} className="flex items-center gap-2 px-6 py-3 rounded-xl border border-border hover:border-primary hover:bg-primary/5 transition-all font-medium">
                <i className="fas fa-phone-alt text-primary" /> {supportNumber}
              </a>
