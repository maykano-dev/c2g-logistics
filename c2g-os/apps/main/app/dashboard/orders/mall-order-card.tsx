          ...
          {!isPaid ? (
            <>
              ...
              <button
                ...
                className={`inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors h-10 px-4 gap-2 flex-1 shadow-lg disabled:opacity-50 disabled:pointer-events-none ${(!order.total_amount || parseFloat(order.total_amount) <= 0)
