...
export default function TrackerClient({ pkg, backLink = "/dashboard/packages", backLabel = "Back to Packages", onBack, walletBalance, registrationFee }: TrackerClientProps) {
