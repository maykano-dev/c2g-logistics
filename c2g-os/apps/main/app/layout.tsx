...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "C2G", "C2G Mall", "C2G Logistics", "C2G Ghana", "C2G Mall Ghana", "C2G Logistics Ghana", "1688 Ghana", "1688 for Ghana", "1688 Ghanaian alternative", "buy from 1688 Ghana", "1688 to Ghana", "buy from China Ghana", "China shopping Ghana", "China marketplace Ghana", "Chinese products Ghana", "Chinese suppliers Ghana", "China wholesale Ghana", "China sourcing Ghana", "China procurement Ghana", "China shipping Ghana", "China logistics Ghana", "China warehouse Ghana", "China freight Ghana", "China to Ghana", "China-to-Ghana shipping", "China import Ghana", "import from China Ghana", "mini importation Ghana", "mini importer Ghana", "China products for resale", "Chinese products for resale Ghana", "wholesale products Ghana", "buy wholesale from China", "China supplier Ghana", "Chinese supplier Ghana", "Alipay alternative Ghana", "buy from China without Alipay", "buy from 1688 without Alipay", "buy from China without Chinese bank account", "shop China with MoMo", "China shopping with MoMo", "Buy For Me China Ghana", "China purchasing service Ghana", "China sourcing service Ghana", "China importation service Ghana", "China-to-Ghana commerce", "China e-commerce Ghana", "Chinese marketplace Ghanaian shoppers"
  ],
  robots: {
    index: true,
    follow: true,
