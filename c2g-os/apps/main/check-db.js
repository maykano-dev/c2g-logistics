...
async function main() {
  const orderPayload = {
    ...
    shipping_method: "sea",
    items: [{ variant_id: 0, spec_id: 'e8974bdc0338179a8afbcb7d1f6ebef7', price_cny: 10, some_random_key_123: false }], 
    subtotal: 10,
    service_fee: 1,
    shipping_cost: 1,
    total_amount: 12,
  ...
  console.log("ecom_orders insert dynamic key response:", data);
}
