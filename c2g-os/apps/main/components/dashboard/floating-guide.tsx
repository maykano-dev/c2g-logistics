  ...
  return (
    <>
      ...
      <motion.button
        ...
        className={`fixed bottom-32 left-4 md:bottom-12 md:left-72 z-[60] w-12 h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center shadow-2xl transition-colors border border-white/20 backdrop-blur-md overflow-hidden group cursor-grab active:cursor-grabbing ${isOpen ? 'bg-zinc-800' : 'bg-primary'}`}
      >
