  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "slide-up-3": "slide-up 0.5s ease-out 0.3s both",
        "slide-up-4": "slide-up 0.5s ease-out 0.4s both",
        "slide-up-5": "slide-up 0.5s ease-out 0.5s both",
        "slide-up-6": "slide-up 0.5s ease-out 0.6s both",
